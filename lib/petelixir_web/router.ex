defmodule PetelixirWeb.Router do
  use PetelixirWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {PetelixirWeb.Layouts, :root}
  ...
  if Application.compile_env(:petelixir, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: PetelixirWeb.Telemetry
