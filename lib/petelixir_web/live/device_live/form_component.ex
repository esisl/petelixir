defmodule PetelixirWeb.DeviceLive.FormComponent do
  use PetelixirWeb, :live_component
  ...
  def render(assigns) do
    ...
    <div>
      ...
      >
        ...
        <.input field={@form[:device_type]} type="text" label="Device type" />
        <.input field={@form[:status]} type="text" label="Status" />
        <.input field={@form[:last_seen]} type="datetime-local" label="Last seen" />
